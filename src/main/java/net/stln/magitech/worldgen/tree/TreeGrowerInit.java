...
public class TreeGrowerInit {
    ...
    public static final DeferredRegister<TrunkPlacerType<?>> TRUNK_PLACER_TYPES =
            DeferredRegister.create(Registries.TRUNK_PLACER_TYPE, Magitech.MOD_ID);

    public static final DeferredHolder<
                    TrunkPlacerType<?>, TrunkPlacerType<RandomBranchingTrunkPlacer>>
            RANDOM_BRANCHING_TRUNK_PLACER =
                    register("random_branching_trunk_placer", RandomBranchingTrunkPlacer.CODEC);

    public static final TreeGrower CELIFERN =
            new TreeGrower(
    ...
    private static <P extends TrunkPlacer>
            DeferredHolder<TrunkPlacerType<?>, TrunkPlacerType<P>> register(
