...
public class CooldownData {
    ...
    private static final Table<Player, Spell, Cooldown> prevCooldownMapClient =
            HashBasedTable.create();
    private static final Table<Player, Spell, Cooldown> prevCooldownMapServer =
            HashBasedTable.create();
    ...
    public static void addCurrentCooldown(
    ...
    public static @Nullable Cooldown getCurrentCooldown(
            @NotNull Player player, @NotNull Spell spell) {
        Table<Player, Spell, Cooldown> table =
                player.level().isClientSide
                        ? CooldownData.cooldownMapClient
                        : CooldownData.cooldownMapServer;
    ...
    public static @Nullable Cooldown getPrevCooldown(@NotNull Player player, @NotNull Spell spell) {
        Table<Player, Spell, Cooldown> table =
                player.level().isClientSide
                        ? CooldownData.prevCooldownMapClient
                        : CooldownData.prevCooldownMapServer;
        return table.get(player, spell);
    }
}
