        ...
        if (livingEntity instanceof Player user) {
            if (ChargeData.getCurrentCharge(user) == null
                ...
                for (int j = 0; j < 10; j++) {
                    level.addParticle(
                            new MembraneParticleEffect(
                                    new Vector3f(1), new Vector3f(1), 5F, 1, 0.3F),
                ...
                for (Entity entity :
                        EntityUtil.getEntitiesInBox(level, user, hitPos, new Vec3(4, 4, 4))) {
                    EffectUtil.entityEffect(
                            level,
                            new MembraneParticleEffect(
                                    new Vector3f(1.0F, 1.0F, 1.0F),
                ...
                if (!level.isClientSide) {
                    livingEntity.addEffect(
                            new MobEffectInstance(
                                    MobEffects.INVISIBILITY, 40, 0, false, false, true));
                    livingEntity.addEffect(
                            new MobEffectInstance(
                                    MobEffects.DAMAGE_RESISTANCE, 40, 1, false, false, true));
                }
