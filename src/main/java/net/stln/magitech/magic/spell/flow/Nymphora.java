            ...
            if (ChargeData.getCurrentCharge(user) == null
                ...
                for (int i = 0; i < 20; i++) {
                    level.addParticle(
                            ...
                            userPos.y,
                            userPos.z,
                            (user.getRandom().nextFloat() - 0.5) / 6,
                            (user.getRandom().nextFloat() - 0.5) / 6 + 0.1,
                            (user.getRandom().nextFloat() - 0.5) / 6);
                    level.addParticle(
                            new SquareParticleEffect(
                                    ...
                                    new Vector3f(0.9F, 1.0F, 0.0F),
                                    1.0F,
                                    user.getRandom().nextInt(5, 7),
                                    (float) ((user.getRandom().nextFloat() - 0.5) / 10)),
                            userPos.x,
                            userPos.y,
                            userPos.z,
                            (user.getRandom().nextFloat() - 0.5) / 6,
                ...
                EffectUtil.entityEffect(
                        ...
                        () ->
                                new SquareParticleEffect(
                                        ...
                                        user.getRandom().nextInt(5, 7),
                                        (float) ((user.getRandom().nextFloat() - 0.5) / 10)),
                        () -> new Vec3(0, user.getRandom().nextFloat() / 8, 0),
                        user,
                        10);
                EffectUtil.entityEffect(
                        level,
