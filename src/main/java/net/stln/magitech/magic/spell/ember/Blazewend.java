                    ...
                    () -> {
                        ...
                        List<Entity> nearbyEntities =
                                EntityUtil.getEntitiesInBox(
                                        level, user, user.position(), new Vec3(3, 3, 3));
                        ...
                        level.playSound(
                                ...
                                user.getY(),
                                user.getZ(),
                                MagitechSounds.BLAZEWEND.get(),
                                SoundSource.PLAYERS,
                                1.0F,
                                0.7F + (user.getRandom().nextFloat() * 0.6F));
                        for (int j = 0; j < 10; j++) {
                            level.addParticle(
                                    new FlameParticleEffect(
                        ...
                        for (Entity entity : nearbyEntities) {
                            ...
                            if (entity instanceof LivingEntity && entity.isAlive()) {
                                ...
                                entity.setRemainingFireTicks(
                                        Math.min(200, entity.getRemainingFireTicks() + 100));
                            }
                        }
