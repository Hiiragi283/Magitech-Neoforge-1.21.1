...
public class MagitechWorldGenInit {
                            ...
                            () ->
                                    new OreSurfaceFeature(
                                            MagitechBlocks.FLUORITE_CRYSTAL_CLUSTER
                                                    .get()
                                                    .defaultBlockState(),
                                            MagitechTags.Blocks.ORES_FLUORITE,
                                            0.25));
    public static final ResourceKey<ConfiguredFeature<?, ?>>
    ...
    public static void biomeModifier(BootstrapContext<BiomeModifier> context) {
    ...
    // GenerationStep.Decoration.UNDERGROUND_DECORATION,
    // MagitechWorldGenInit.REDSTONE_CRYSTAL_SURFACE_PLACED_KEY
    // );
    // BiomeModifications.addFeature(
    // BiomeSelectors.foundInOverworld(),
    // GenerationStep.Decoration.UNDERGROUND_DECORATION,
    // MagitechWorldGenInit.FLUORITE_CRYSTAL_SURFACE_PLACED_KEY
    // );
    // BiomeModifications.addFeature(
    // BiomeSelectors.foundInOverworld(),
    // GenerationStep.Decoration.UNDERGROUND_ORES,
    // MagitechWorldGenInit.FLUORITE_ORE_PLACED_KEY
    // );
    // }
