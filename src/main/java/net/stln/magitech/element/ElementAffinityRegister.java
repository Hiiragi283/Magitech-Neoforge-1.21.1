...
public class ElementAffinityRegister {
    ...
    public static @NotNull ElementAffinity getElementAffinity(
            @NotNull Element element, @NotNull Element targetElement) {
    ...
    public static void registerAffinity(
            @NotNull Element element, boolean efficiency, @NotNull Element target) {
