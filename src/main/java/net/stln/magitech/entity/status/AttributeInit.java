...
public class AttributeInit {
    ...
    public static final DeferredHolder<Attribute, Attribute> MAX_MANA =
            ATTRIBUTES.register(
                    ...
                    () ->
                            (new RangedAttribute(
                                            "attribute.magitech.max_mana", 100, 0, Double.MAX_VALUE)
                                    .setSyncable(true)));
    public static final DeferredHolder<Attribute, Attribute> MANA_REGEN =
            ATTRIBUTES.register(
                    ...
                    () ->
                            (new RangedAttribute(
                                            "attribute.magitech.mana_regen", 2, 0, Double.MAX_VALUE)
                                    .setSyncable(true)));
    ...
    public static final DeferredHolder<Attribute, Attribute> NOCTIS_REGEN =
            ATTRIBUTES.register(
                    ...
                    () ->
                            (new RangedAttribute(
                                            "attribute.magitech.noctis_regen",
                                            0.5,
                                            0,
                                            Double.MAX_VALUE)
                                    .setSyncable(true)));
    public static final DeferredHolder<Attribute, Attribute> MAX_LUMINIS =
            ATTRIBUTES.register(
                    ...
                    () ->
                            (new RangedAttribute(
                                            "attribute.magitech.max_luminis",
                                            50,
                                            0,
                                            Double.MAX_VALUE)
                                    .setSyncable(true)));
    public static final DeferredHolder<Attribute, Attribute> LUMINIS_REGEN =
            ATTRIBUTES.register(
                    ...
                    () ->
                            (new RangedAttribute(
                                            "attribute.magitech.luminis_regen",
                                            0.5,
                                            0,
                                            Double.MAX_VALUE)
                                    .setSyncable(true)));
    ...
    public static final DeferredHolder<Attribute, Attribute> FLUXIA_REGEN =
            ATTRIBUTES.register(
                    ...
                    () ->
                            (new RangedAttribute(
                                            "attribute.magitech.fluxia_regen",
                                            0.5,
                                            0,
                                            Double.MAX_VALUE)
                                    .setSyncable(true)));
    ...
    public static final DeferredHolder<Attribute, Attribute> EMBER_SPELL_POWER =
            ATTRIBUTES.register(
                    ...
                    () ->
                            (new PercentageAttribute(
                                            "attribute.magitech.ember_spell_power",
                                            1,
                                            0,
                                            Double.MAX_VALUE)
                                    .setSyncable(true)));
    public static final DeferredHolder<Attribute, Attribute> GLACE_SPELL_POWER =
            ATTRIBUTES.register(
                    ...
                    () ->
                            (new PercentageAttribute(
                                            "attribute.magitech.glace_spell_power",
                                            1,
                                            0,
                                            Double.MAX_VALUE)
                                    .setSyncable(true)));
    public static final DeferredHolder<Attribute, Attribute> SURGE_SPELL_POWER =
            ATTRIBUTES.register(
                    ...
                    () ->
                            (new PercentageAttribute(
                                            "attribute.magitech.surge_spell_power",
                                            1,
                                            0,
                                            Double.MAX_VALUE)
                                    .setSyncable(true)));
    public static final DeferredHolder<Attribute, Attribute> PHANTOM_SPELL_POWER =
            ATTRIBUTES.register(
                    ...
                    () ->
                            (new PercentageAttribute(
                                            "attribute.magitech.phantom_spell_power",
                                            1,
                                            0,
                                            Double.MAX_VALUE)
                                    .setSyncable(true)));
    public static final DeferredHolder<Attribute, Attribute> TREMOR_SPELL_POWER =
            ATTRIBUTES.register(
                    ...
                    () ->
                            (new PercentageAttribute(
                                            "attribute.magitech.tremor_spell_power",
                                            1,
                                            0,
                                            Double.MAX_VALUE)
                                    .setSyncable(true)));
    public static final DeferredHolder<Attribute, Attribute> MAGIC_SPELL_POWER =
            ATTRIBUTES.register(
                    ...
                    () ->
                            (new PercentageAttribute(
                                            "attribute.magitech.magic_spell_power",
                                            1,
                                            0,
                                            Double.MAX_VALUE)
                                    .setSyncable(true)));
    public static final DeferredHolder<Attribute, Attribute> FLOW_SPELL_POWER =
            ATTRIBUTES.register(
                    ...
                    () ->
                            (new PercentageAttribute(
                                            "attribute.magitech.flow_spell_power",
                                            1,
                                            0,
                                            Double.MAX_VALUE)
                                    .setSyncable(true)));
    public static final DeferredHolder<Attribute, Attribute> HOLLOW_SPELL_POWER =
            ATTRIBUTES.register(
                    ...
                    () ->
                            (new PercentageAttribute(
                                            "attribute.magitech.hollow_spell_power",
                                            1,
                                            0,
                                            Double.MAX_VALUE)
                                    .setSyncable(true)));
