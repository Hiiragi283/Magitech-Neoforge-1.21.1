                            ...
                            CreativeModeTab.builder()
                                    ...
                                    .displayItems(
                                            (parameters, output) -> {
                                                ...
                                                output.accept(
                                                        PartToolGenerator.generateDagger(
                                                                MaterialInit.AMETHYST));
                                                output.accept(
                                                        PartToolGenerator.generateDagger(
                                                                MaterialInit.CITRINE));
                                                output.accept(
                                                        PartToolGenerator.generateDagger(
                                                                MaterialInit.REDSTONE));
                                                output.accept(
                                                        PartToolGenerator.generateDagger(
                                                                MaterialInit.LAPIS));
                                                output.accept(
                                                        PartToolGenerator.generateDagger(
                                                                MaterialInit.CALCITE));
                                                output.accept(
                                                        PartToolGenerator.generateDagger(
                                                                MaterialInit.DRIPSTONE));
                                                output.accept(
                                                        PartToolGenerator.generateDagger(
                                                                MaterialInit.FLUORITE));
                                                output.accept(
                                                        PartToolGenerator.generateDagger(
                                                                MaterialInit.DIAMOND));
                                                output.accept(
                                                        PartToolGenerator.generateDagger(
                                                                MaterialInit.EMERALD));
                                                output.accept(
                                                        PartToolGenerator.generateDagger(
                                                                MaterialInit.ENDER_METAL));
                                                output.accept(
                                                        PartToolGenerator.generateDagger(
                                                                MaterialInit.QUARTZ));
                                                output.accept(
                                                        PartToolGenerator.generateDagger(
                                                                MaterialInit.GLOWSTONE));
                                                output.accept(
                                                        PartToolGenerator.generateDagger(
                                                                MaterialInit.NETHERITE));
                                                output.accept(
                                                        PartToolGenerator.generateDagger(
                                                                MaterialInit.RADIANT_STEEL));
                                                output.accept(
                                                        PartToolGenerator.generateDagger(
                                                                MaterialInit.FRIGIDITE));
                                                output.accept(
                                                        PartToolGenerator.generateDagger(
                                                                MaterialInit.TRANSLUCIUM));
                                                output.accept(
                                                        PartToolGenerator.generateDagger(
                                                                MaterialInit.RESONITE));
                                                output.accept(
                                                        PartToolGenerator.generateDagger(
                                                                MaterialInit.ABYSSITE));
                            ...
                            CreativeModeTab.builder()
                                    ...
                                    .displayItems(
                                            (parameters, output) -> {
                                                ...
                                                output.accept(
                                                        ThreadboundGenerator.generateThreadPage(
                                                                SpellInit.TENEBRISOL));
                                                output.accept(
                                                        ThreadboundGenerator.generateThreadPage(
                                                                SpellInit.DISPARUNDRA));
                                                output.accept(
                                                        ThreadboundGenerator.generateThreadPage(
                                                                SpellInit.TENEBPORT));
