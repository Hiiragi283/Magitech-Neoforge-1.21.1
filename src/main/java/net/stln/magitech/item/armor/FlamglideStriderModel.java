...
public class FlamglideStriderModel extends GeoModel<FlamglideStriderItem> {
    ...
    public static final ResourceLocation TEXTURE =
            Magitech.id("textures/armor/flamglide_strider.png");
    public static final ResourceLocation GEO =
            Magitech.id("geo/item/armor/flamglide_strider.geo.json");
    public static final ResourceLocation ANIM =
            Magitech.id("animations/armor/flamglide_strider.animation.json");
