...
public record SpellComponent(List<Spell> spells, int selected) {
    ...
    public static final Codec<SpellComponent> CODEC =
                    ...
                    instance ->
                            instance.group(
                                            Spell.CODEC
                                                    .listOf()
                                                    .fieldOf("spells")
                                                    .forGetter(SpellComponent::spells),
                                            Codec.INT
                                                    .fieldOf("selected")
                                                    .forGetter(SpellComponent::selected))
                                    .apply(instance, SpellComponent::new));
    public static final StreamCodec<RegistryFriendlyByteBuf, SpellComponent> STREAM_CODEC =
