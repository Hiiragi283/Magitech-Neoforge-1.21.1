...
public record MaterialComponent(@NotNull ToolMaterial material) {
    ...
    public static final Codec<MaterialComponent> CODEC =
            ToolMaterial.CODEC.xmap(MaterialComponent::new, MaterialComponent::material);
    public static final StreamCodec<RegistryFriendlyByteBuf, MaterialComponent> STREAM_CODEC =
            ToolMaterial.STREAM_CODEC.map(MaterialComponent::new, MaterialComponent::material);
