...
public class SmoothTrait extends Trait {
    ...
    public void modifyEnchantmentOnBlockLooting(
        ...
        super.modifyEnchantmentOnBlockLooting(
                player, level, stack, traitLevel, stats, blockState, pos, lootStack);
    }
    ...
    public double modifyExpOnBlockLooting(
        ...
        return super.modifyExpOnBlockLooting(
                player, level, stack, traitLevel, stats, blockState, pos, lootStack, exp);
    }
