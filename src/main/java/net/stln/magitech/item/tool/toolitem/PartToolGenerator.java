...
public class PartToolGenerator {
    ...
    public static ItemStack generateLightSword(
    ...
    public static ItemStack generateHeavySword(
            ToolMaterialLike handle,
            ToolMaterialLike blade,
            ToolMaterialLike toolBinding,
            ToolMaterialLike handguard) {
    ...
    public static ItemStack generateHammer(
            ToolMaterialLike handle,
    ...
    public static ItemStack generateAxe(
            ToolMaterialLike handle,
            ToolMaterialLike blade,
            ToolMaterialLike strikeHead,
            ToolMaterialLike toolBinding) {
    ...
    public static ItemStack generateShovel(
            ToolMaterialLike handle,
            ToolMaterialLike blade,
            ToolMaterialLike plate,
            ToolMaterialLike toolBinding) {
    ...
    public static ItemStack generateScythe(
            ToolMaterialLike reinforcedStick,
            ToolMaterialLike handle,
            ToolMaterialLike blade,
            ToolMaterialLike toolBinding) {
