...
public class ModelRegistrar {
    ...
    public static final List<String> toolTypes =
            List.of(
                    ...
                    "staff",
                    "wandrel");
    public static final List<String> partTypes =
            List.of(
                    "light_blade",
                    "heavy_blade",
                    "light_handle",
    ...
    public static void registerAdditionalModels(ModelEvent.RegisterAdditional registerAdditional) {
                        ...
                        material -> {
                            for (String type : toolTypes) {
                                for (String part : partTypes) {
                                    ResourceLocation partModelId =
                                            getPartModelId(material, type, part);
                                    if (Minecraft.getInstance()
                                            ...
                                            .getResource(
                                                    partModelId
                                                            ...
                                                            .withSuffix(".json"))
                                            .isPresent()) {
                                        registerAdditional.register(
                                                ModelResourceLocation.standalone(partModelId));
                                    }
                                }
                            }
                        });
        MagitechRegistries.TOOL_MATERIAL.stream()
                .forEach(
                        material -> {
                            for (String part : partTypes) {
                                ResourceLocation partItemModelId =
                                        getPartItemModelId(material, part);
                                if (Minecraft.getInstance()
                                        .getResourceManager()
                                        .getResource(
                                                partItemModelId
                                        ...
                                        .isPresent()) {
                                    registerAdditional.register(
                                            ModelResourceLocation.standalone(partItemModelId));
                                }
                            }
                        });
    }

    public static ResourceLocation getPartTextureId(
