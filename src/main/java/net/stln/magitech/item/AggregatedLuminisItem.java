...
public class AggregatedLuminisItem extends TooltipTextItem {
    ...
    public InteractionResultHolder<ItemStack> use(
        ...
        if (currentMana < maxMana) {
            ...
            EffectUtil.entityEffect(
                    ...
                    20);
            ManaUtil.setMana(
                    player, ManaUtil.ManaType.LUMINIS, Math.min(currentMana + 15, maxMana));
    ...
    // 0.75);
    // level.addParticle(new PowerupParticleEffect(new Vector3f(1.0F, 1.0F, 0.9F),
    // new
    // Vector3f(1.0F, 0.8F, 0.5F), 1F, 1, 0), x, y, z, 0, 0, 0);
    // }
    ...
    public void appendHoverText(
        ...
        tooltipComponents.add(
                Component.translatable("tooltip.hint.item.magitech.aggregated_luminis")
                        .withColor(0xFFF0C0));
