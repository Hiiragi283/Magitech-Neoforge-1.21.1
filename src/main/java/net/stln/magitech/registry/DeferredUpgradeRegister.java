...
public class DeferredUpgradeRegister extends DeferredRegister<Upgrade> {
    ...
    @Override
    public <I extends Upgrade> @NotNull DeferredUpgrade<I> register(
    ...
    @Override
    protected <I extends Upgrade> @NotNull DeferredUpgrade<I> createHolder(
            @NotNull ResourceKey<? extends Registry<Upgrade>> registryKey,
