...
public class DeferredToolMaterialRegister extends DeferredRegister<ToolMaterial> {
    ...
    @Override
    public <I extends ToolMaterial> @NotNull DeferredToolMaterial<I> register(
            @NotNull String name, @NotNull Supplier<? extends I> sup) {
    ...
    @Override
    public <I extends ToolMaterial> @NotNull DeferredToolMaterial<I> register(
            @NotNull String name, @NotNull Function<ResourceLocation, ? extends I> func) {
        return (DeferredToolMaterial<I>) super.register(name, func);
    }

    @Override
    protected <I extends ToolMaterial> @NotNull DeferredToolMaterial<I> createHolder(
            @NotNull ResourceKey<? extends Registry<ToolMaterial>> registryKey,
