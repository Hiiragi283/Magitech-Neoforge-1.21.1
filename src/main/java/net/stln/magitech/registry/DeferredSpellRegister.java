...
public class DeferredSpellRegister extends DeferredRegister<Spell> {
    ...
    @Override
    public <I extends Spell> @NotNull DeferredSpell<I> register(
    ...
    @Override
    protected <I extends Spell> @NotNull DeferredSpell<I> createHolder(
            @NotNull ResourceKey<? extends Registry<Spell>> registryKey,
