...
public class SquareFieldParticleEffect extends AbstractCustomizableParticleEffect {

    public static final MapCodec<SquareFieldParticleEffect> CODEC =
                            ...
                            instance.group(
                                            ...
                                            ROTATE_SPEED_CODEC
                                                    ...
                                                    .forGetter(
                                                            AbstractCustomizableParticleEffect
                                                                    ::getRotSpeed))
                                    .apply(instance, SquareFieldParticleEffect::new));
    public static final StreamCodec<ByteBuf, SquareFieldParticleEffect> STREAM_CODEC =
            StreamCodec.composite(
                    ...
                    SquareFieldParticleEffect::new);

    private final Vector3f fromColor;
    private final Vector3f toColor;

    public SquareFieldParticleEffect(
    ...
    @Override
    public ParticleType<SquareFieldParticleEffect> getType() {
        return MagitechParticleTypes.SQUARE_FIELD.get();
    }
}
