...
public class PowerupNoCullParticleEffect extends AbstractCustomizableParticleEffect {
    ...
    public static final MapCodec<PowerupNoCullParticleEffect> CODEC =
    ...
    public static final StreamCodec<ByteBuf, PowerupNoCullParticleEffect> STREAM_CODEC =
    ...
    public PowerupNoCullParticleEffect(
    ...
    public ParticleType<PowerupNoCullParticleEffect> getType() {
        return MagitechParticleTypes.POWERUP_NO_CULL.get();
    }
}
