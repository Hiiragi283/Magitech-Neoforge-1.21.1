...
public class WaveNoCullParticleEffect extends AbstractCustomizableParticleEffect {

    public static final MapCodec<WaveNoCullParticleEffect> CODEC =
                            ...
                            instance.group(
                                            ...
                                            ROTATE_SPEED_CODEC
                                                    ...
                                                    .forGetter(
                                                            AbstractCustomizableParticleEffect
                                                                    ::getRotSpeed))
                                    .apply(instance, WaveNoCullParticleEffect::new));
    public static final StreamCodec<ByteBuf, WaveNoCullParticleEffect> STREAM_CODEC =
            StreamCodec.composite(
                    ...
                    WaveNoCullParticleEffect::new);

    private final Vector3f fromColor;
    private final Vector3f toColor;

    public WaveNoCullParticleEffect(
    ...
    @Override
    public ParticleType<WaveNoCullParticleEffect> getType() {
        return MagitechParticleTypes.WAVE_NO_CULL.get();
    }
}
