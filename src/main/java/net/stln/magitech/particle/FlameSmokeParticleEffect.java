...
public class FlameSmokeParticleEffect extends AbstractCustomizableParticleEffect {

    public static final MapCodec<FlameSmokeParticleEffect> CODEC =
                            ...
                            instance.group(
                                            ...
                                            ROTATE_SPEED_CODEC
                                                    ...
                                                    .forGetter(
                                                            AbstractCustomizableParticleEffect
                                                                    ::getRotSpeed))
                                    .apply(instance, FlameSmokeParticleEffect::new));
    public static final StreamCodec<ByteBuf, FlameSmokeParticleEffect> STREAM_CODEC =
            StreamCodec.composite(
                    ...
                    FlameSmokeParticleEffect::new);

    private final Vector3f fromColor;
    private final Vector3f toColor;

    public FlameSmokeParticleEffect(
    ...
    @Override
    public ParticleType<FlameSmokeParticleEffect> getType() {
        return MagitechParticleTypes.FLAME_SMOKE.get();
    }
}
