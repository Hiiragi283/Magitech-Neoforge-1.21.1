...
public class FlameParticleEffect extends AbstractCustomizableParticleEffect {

    public static final MapCodec<FlameParticleEffect> CODEC =
    ...
    public static final StreamCodec<ByteBuf, FlameParticleEffect> STREAM_CODEC =
    ...
    @Override
    public ParticleType<FlameParticleEffect> getType() {
        return MagitechParticleTypes.FLAME.get();
    }
}
