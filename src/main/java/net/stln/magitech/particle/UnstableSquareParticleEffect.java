...
public class UnstableSquareParticleEffect extends AbstractCustomizableParticleEffect {
    ...
    public static final MapCodec<UnstableSquareParticleEffect> CODEC =
    ...
    public static final StreamCodec<ByteBuf, UnstableSquareParticleEffect> STREAM_CODEC =
    ...
    public UnstableSquareParticleEffect(
    ...
    public ParticleType<UnstableSquareParticleEffect> getType() {
        return MagitechParticleTypes.UNSTABLE_SQUARE.get();
    }
}
