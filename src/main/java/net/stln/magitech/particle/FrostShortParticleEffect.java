...
public class FrostShortParticleEffect extends AbstractCustomizableParticleEffect {

    public static final MapCodec<FrostShortParticleEffect> CODEC =
                            ...
                            instance.group(
                                            ...
                                            ROTATE_SPEED_CODEC
                                                    ...
                                                    .forGetter(
                                                            AbstractCustomizableParticleEffect
                                                                    ::getRotSpeed))
                                    .apply(instance, FrostShortParticleEffect::new));
    public static final StreamCodec<ByteBuf, FrostShortParticleEffect> STREAM_CODEC =
            StreamCodec.composite(
                    ...
                    FrostShortParticleEffect::new);

    private final Vector3f fromColor;
    private final Vector3f toColor;

    public FrostShortParticleEffect(
    ...
    @Override
    public ParticleType<FrostShortParticleEffect> getType() {
        return MagitechParticleTypes.FROST_SHORT.get();
    }
}
