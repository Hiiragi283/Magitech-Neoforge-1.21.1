...
public class BlowParticleEffect extends AbstractCustomizableParticleEffect {

    public static final MapCodec<BlowParticleEffect> CODEC =
                            ...
                            instance.group(
                                            ...
                                            ROTATE_SPEED_CODEC
                                                    ...
                                                    .forGetter(
                                                            AbstractCustomizableParticleEffect
                                                                    ::getRotSpeed))
                                    .apply(instance, BlowParticleEffect::new));
    public static final StreamCodec<ByteBuf, BlowParticleEffect> STREAM_CODEC =
            StreamCodec.composite(
                    ...
                    BlowParticleEffect::new);

    private final Vector3f fromColor;
    private final Vector3f toColor;

    public BlowParticleEffect(
    ...
    @Override
    public ParticleType<BlowParticleEffect> getType() {
        return MagitechParticleTypes.BLOW.get();
    }
}
