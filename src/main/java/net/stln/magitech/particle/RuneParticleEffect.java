...
public class RuneParticleEffect extends AbstractCustomizableParticleEffect {

    public static final MapCodec<RuneParticleEffect> CODEC =
                            ...
                            instance.group(
                                            ...
                                            ROTATE_SPEED_CODEC
                                                    ...
                                                    .forGetter(
                                                            AbstractCustomizableParticleEffect
                                                                    ::getRotSpeed))
                                    .apply(instance, RuneParticleEffect::new));
    public static final StreamCodec<ByteBuf, RuneParticleEffect> STREAM_CODEC =
    ...
    @Override
    public ParticleType<RuneParticleEffect> getType() {
        return MagitechParticleTypes.RUNE.get();
    }
}
