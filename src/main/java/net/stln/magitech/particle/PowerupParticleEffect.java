...
public class PowerupParticleEffect extends AbstractCustomizableParticleEffect {

    public static final MapCodec<PowerupParticleEffect> CODEC =
                            ...
                            instance.group(
                                            ...
                                            ROTATE_SPEED_CODEC
                                                    ...
                                                    .forGetter(
                                                            AbstractCustomizableParticleEffect
                                                                    ::getRotSpeed))
                                    .apply(instance, PowerupParticleEffect::new));
    public static final StreamCodec<ByteBuf, PowerupParticleEffect> STREAM_CODEC =
            StreamCodec.composite(
                    ...
                    PowerupParticleEffect::new);

    private final Vector3f fromColor;
    private final Vector3f toColor;

    public PowerupParticleEffect(
    ...
    @Override
    public ParticleType<PowerupParticleEffect> getType() {
        return MagitechParticleTypes.POWERUP.get();
    }
}
