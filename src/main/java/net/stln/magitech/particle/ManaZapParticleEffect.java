...
public class ManaZapParticleEffect extends AbstractCustomizableParticleEffect {
    ...
    public static final MapCodec<ManaZapParticleEffect> CODEC =
    ...
    public static final StreamCodec<ByteBuf, ManaZapParticleEffect> STREAM_CODEC =
    ...
    @Override
    public ParticleType<ManaZapParticleEffect> getType() {
        return MagitechParticleTypes.MANA_ZAP.get();
    }
}
