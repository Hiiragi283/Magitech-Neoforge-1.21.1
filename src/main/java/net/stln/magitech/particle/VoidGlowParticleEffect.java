...
public class VoidGlowParticleEffect extends AbstractCustomizableParticleEffect {

    public static final MapCodec<VoidGlowParticleEffect> CODEC =
                            ...
                            instance.group(
                                            ...
                                            ROTATE_SPEED_CODEC
                                                    ...
                                                    .forGetter(
                                                            AbstractCustomizableParticleEffect
                                                                    ::getRotSpeed))
                                    .apply(instance, VoidGlowParticleEffect::new));
    public static final StreamCodec<ByteBuf, VoidGlowParticleEffect> STREAM_CODEC =
            StreamCodec.composite(
                    ...
                    VoidGlowParticleEffect::new);

    private final Vector3f fromColor;
    private final Vector3f toColor;

    public VoidGlowParticleEffect(
    ...
    @Override
    public ParticleType<VoidGlowParticleEffect> getType() {
        return MagitechParticleTypes.VOID_GLOW.get();
    }
}
