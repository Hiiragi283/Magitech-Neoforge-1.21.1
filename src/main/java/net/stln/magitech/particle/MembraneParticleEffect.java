...
public class MembraneParticleEffect extends AbstractCustomizableParticleEffect {
    ...
    public static final MapCodec<MembraneParticleEffect> CODEC =
    ...
    public static final StreamCodec<ByteBuf, MembraneParticleEffect> STREAM_CODEC =
    ...
    public ParticleType<MembraneParticleEffect> getType() {
        return MagitechParticleTypes.MEMBRANE.get();
    }
}
