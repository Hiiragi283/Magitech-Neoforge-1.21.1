...
public class SquareNoCullParticleEffect extends AbstractCustomizableParticleEffect {

    public static final MapCodec<SquareNoCullParticleEffect> CODEC =
                            ...
                            instance.group(
                                            ...
                                            ROTATE_SPEED_CODEC
                                                    ...
                                                    .forGetter(
                                                            AbstractCustomizableParticleEffect
                                                                    ::getRotSpeed))
                                    .apply(instance, SquareNoCullParticleEffect::new));
    public static final StreamCodec<ByteBuf, SquareNoCullParticleEffect> STREAM_CODEC =
            StreamCodec.composite(
                    ...
                    SquareNoCullParticleEffect::new);

    private final Vector3f fromColor;
    private final Vector3f toColor;

    public SquareNoCullParticleEffect(
    ...
    @Override
    public ParticleType<SquareNoCullParticleEffect> getType() {
        return MagitechParticleTypes.SQUARE_NO_CULL.get();
    }
}
