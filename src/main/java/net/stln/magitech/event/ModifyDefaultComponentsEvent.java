...
public class ModifyDefaultComponentsEvent {
    ...
    public static void modifyDefault(
        ...
        event.modify(
                ...
                builder ->
                        builder.set(
                                        ComponentInit.PART_MATERIAL_COMPONENT.get(),
        ...
        event.modify(
                ...
                builder ->
                        builder.set(
                                        ComponentInit.MATERIAL_COMPONENT.get(),
                                        new MaterialComponent(MaterialInit.IRON))
                                .set(ComponentInit.UPGRADE_COMPONENT.get(), UpgradeComponent.EMPTY)
                                .build());
        event.modify(
        ...
        if (ModList.get().isLoaded("patchouli")) {
            event.modify(
                    ...
                    builder ->
                            builder.set(ComponentInit.SPELL_COMPONENT.get(), SpellComponent.EMPTY)
                                    .set(
        ...
        event.modify(
                ...
                builder ->
                        builder.set(
                                        ComponentInit.THREAD_PAGE_COMPONENT.get(),
                                        new ThreadPageComponent(SpellInit.ENERCRUX))
                                .build());
    }
}
