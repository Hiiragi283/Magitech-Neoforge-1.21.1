                                            ...
                                            (parameters, output) -> {
                                                ...
                                                output.accept(
                                                        ThreadboundGenerator.generateThreadbound(
                                                                ItemInit.GLISTENING_LEXICON.get(),
                                                                allSpells));
                                                output.accept(
                                                        ThreadboundGenerator.generateThreadbound(
                                                                ItemInit.THE_FIRE_THAT_THINKS.get(),
                                                                allSpells));
                                                output.accept(
                                                        ThreadboundGenerator.generateThreadbound(
                                                                ItemInit
                                    ...
                                    .icon(
                                            () ->
                                                    PartToolGenerator.generatePart(
                                                            (PartItem) ItemInit.LIGHT_BLADE.get(),
                                                            MagitechToolMaterials.FLUORITE))
