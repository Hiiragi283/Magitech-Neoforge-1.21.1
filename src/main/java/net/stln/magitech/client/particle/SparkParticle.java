...
public class SparkParticle extends GlowingParticle {
    ...
    public SparkParticle(
            ...
            double vy,
            double vz,
            SparkParticleEffect parameters,
        ...
        this.lifetime = 5 + clientWorld.random.nextInt(0, 10);
        this.alpha = 1.0F;
    ...
    public static class Provider implements ParticleProvider<SparkParticleEffect> {
        ...
        public @Nullable Particle createParticle(
                ...
                double yd,
                double zd) {
            return new SparkParticle(world, x, y, z, xd, yd, zd, parameters, this.spriteProvider);
        }
    }
}
