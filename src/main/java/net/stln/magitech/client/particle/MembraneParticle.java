...
public class MembraneParticle extends GlowingParticle {

    private final SpriteSet spriteProvider;
    private final Vector3f startColor;
    private final Vector3f endColor;

    public MembraneParticle(
            ...
            double vy,
            double vz,
            MembraneParticleEffect parameters,
        ...
        this.rotSpeed = parameters.getRotSpeed() + (clientWorld.random.nextFloat() - 0.5F) / 5;
    }
