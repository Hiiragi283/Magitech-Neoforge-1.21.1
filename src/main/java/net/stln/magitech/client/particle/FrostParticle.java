...
public class FrostParticle extends GlowingParticle {
    ...
    public FrostParticle(
            ...
            double vy,
            double vz,
            FrostParticleEffect parameters,
    ...
    public static class Provider implements ParticleProvider<FrostParticleEffect> {
        ...
        public @Nullable Particle createParticle(
                ...
                double yd,
                double zd) {
            return new FrostParticle(world, x, y, z, xd, yd, zd, parameters, this.spriteProvider);
        }
    }
}
