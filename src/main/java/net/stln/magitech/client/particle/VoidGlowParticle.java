...
public class VoidGlowParticle extends GlowingParticle {

    private final SpriteSet spriteProvider;
    private final Vector3f startColor;
    private final Vector3f endColor;

    public VoidGlowParticle(
            ...
            double vy,
            double vz,
            VoidGlowParticleEffect parameters,
        ...
        this.lifetime = 1 + clientWorld.random.nextInt(0, 20);
        this.alpha = 1.0F;
    ...
    public static class Provider implements ParticleProvider<VoidGlowParticleEffect> {
