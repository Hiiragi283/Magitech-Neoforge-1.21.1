...
import net.stln.magitech.client.model.entity.TremivoxModel;
...
public class TremivoxRenderer extends GeoEntityRenderer<TremivoxEntity> {
    ...
    @Override
    public Color getRenderColor(TremivoxEntity animatable, float partialTick, int packedLight) {
        return Color.WHITE;
    }

    @Override
    public @Nullable RenderType getRenderType(
            TremivoxEntity animatable,
