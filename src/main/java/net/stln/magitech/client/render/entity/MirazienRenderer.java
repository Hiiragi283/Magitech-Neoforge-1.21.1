package net.stln.magitech.client.render.entity;
...
import net.stln.magitech.client.model.entity.MirazienModel;
...
public class MirazienRenderer extends GeoEntityRenderer<MirazienEntity> {
    ...
    @Override
    public Color getRenderColor(MirazienEntity animatable, float partialTick, int packedLight) {
        return Color.WHITE;
    }

    @Override
    public @Nullable RenderType getRenderType(
            MirazienEntity animatable,
