...
import net.stln.magitech.client.model.entity.IgniscaModel;
...
public class IgniscaRenderer extends GeoEntityRenderer<IgniscaEntity> {
    ...
    @Override
    public Color getRenderColor(IgniscaEntity animatable, float partialTick, int packedLight) {
        return Color.WHITE;
    }

    @Override
    public @Nullable RenderType getRenderType(
            IgniscaEntity animatable,
