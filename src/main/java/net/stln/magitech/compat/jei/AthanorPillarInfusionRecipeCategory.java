...
public class AthanorPillarInfusionRecipeCategory
    ...
    public static final ResourceLocation UID =
            Magitech.id("recipe.magitech.athanor_pillar_infusion");
    public static final ResourceLocation TEXTURE = Magitech.id("textures/gui/jei_widgets.png");

    public static final RecipeType<AthanorPillarInfusionRecipe>
    ...
    @Override
    public void draw(
            @NotNull AthanorPillarInfusionRecipe recipe,
