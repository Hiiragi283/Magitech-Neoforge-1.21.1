...
public class BiomeInit {
    ...
    public static final ResourceKey<Biome> MISTJADE_FOREST =
            ResourceKey.create(Registries.BIOME, Magitech.id("mistjade_forest"));

    public static final ResourceKey<Biome> SCORCHED_PLAINS =
            ResourceKey.create(Registries.BIOME, Magitech.id("scorched_plains"));
    ...
    public static final TagKey<Biome> HAS_CHARCOAL_BIRCH_FOREST =
            createTagKey("has_charcoal_birch_forest");
