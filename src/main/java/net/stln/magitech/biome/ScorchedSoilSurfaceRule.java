...
public class ScorchedSoilSurfaceRule {
    ...
    private static final SurfaceRules.RuleSource SCORCHED_GRASS_SOIL =
            makeStateRule(BlockInit.SCORCHED_GRASS_SOIL.get());
    private static final SurfaceRules.RuleSource SCORCHED_SOIL =
            makeStateRule(BlockInit.SCORCHED_SOIL.get());
    ...
    protected static SurfaceRules.RuleSource makeRule() {
        ...
        return SurfaceRules.sequence(
                SurfaceRules.ifTrue(
                        SurfaceRules.isBiome(BiomeInit.SCORCHED_PLAINS), scorchedSurface),
