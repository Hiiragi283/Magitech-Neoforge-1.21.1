...
public record ZardiusCrucibleRecipe(
        String group,
                    ...
                    instance ->
                            instance.group(
                                            Codec.STRING
                                                    ...
                                                    .forGetter(ZardiusCrucibleRecipe::group),
                                            Ingredient.CODEC_NONEMPTY
                                                    .listOf(1, Integer.MAX_VALUE)
                                                    .fieldOf("ingredients")
                                                    .forGetter(ZardiusCrucibleRecipe::ingredients),
                                            ...
                                            ItemStack.STRICT_CODEC
                                                    ...
                                                    .forGetter(ZardiusCrucibleRecipe::result),
                                            FluidStack.CODEC
    ...
    public @NotNull ItemStack assemble(
            @NotNull CrucibleRecipeInput input, HolderLookup.@NotNull Provider registries) {
